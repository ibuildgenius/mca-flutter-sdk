...
Widget getLogo(String name) {
  ...
  if (newName.contains("mcg") || newName.contains("mycovergenius")) {
    return Image.asset("assets/images/mcg.png",
        package: 'mca_official_flutter_sdk');
  } else if (newName.contains("aiico")) {
    return Image.asset("assets/images/aiico.png",
        package: 'mca_official_flutter_sdk');
  } else if (newName.contains("sti")) {
    return Image.asset("assets/images/sti.png",
        package: 'mca_official_flutter_sdk');
  } else if (newName.contains("flexicare")) {
    return Image.asset("assets/images/flexicare.png",
        package: 'mca_official_flutter_sdk');
  } else if (newName.contains("leadway")) {
    return Image.asset("assets/images/leadway.png",
        package: 'mca_official_flutter_sdk');
  } else {
    return Text(
      name,
    ...
    child: Center(
      child: Text(title,
          style: GoogleFonts.spaceGrotesk(
              fontSize: 12,
              fontWeight:
                  selectedTabIndex == index ? FontWeight.w600 : FontWeight.w500,
              color: selectedTabIndex == index
                  ? PRIMARY
                  : CustomColors.claimTextColor)),
    ),
  );
}
